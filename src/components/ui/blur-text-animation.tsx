...
export default function BlurTextAnimation({
  ...
  fontFamily = "font-['Montserrat',_system-ui,_sans-serif]",
  textColor = "text-[#17204E]",
  animationDelay = 4000
  ...
  return (
    <div className={className}>
      <h1 className={`${textColor} ${fontSize} ${fontFamily} font-black leading-[1.1] tracking-tighter mb-8`}>
          ...
          <span
            ...
            style={{
              ...
              textShadow: isAnimating 
                ? 'none' 
                : '0 0 40px rgba(0,0,0,0.2)' // Adjusted for light theme
            }}
          >
            {word.text}
          </span>
